...
it('renders the public services page grouped by real category', function () {
    get(route('services'))
        ...
        // No `escape: false` here: the service name contains a literal "&",
        // which Blade renders as "&amp;". With escape: false the needle would
        // be searched for raw and could never match the escaped served bytes.
