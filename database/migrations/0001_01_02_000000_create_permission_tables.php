...
/**
 * Spatie laravel-permission schema (see ARCHITECTURE.md §20 — package
 * decision confirmed at LEVEL 0). Actual roles/permissions/policy wiring
 * is implemented at LEVEL 4; this migration only establishes the schema
 * so `teams` (added below) can be referenced by team-scoped permissions
