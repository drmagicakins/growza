...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Notifications','heading' => 'Notifications']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Notifications','heading' => 'Notifications']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'No notifications yet','description' => 'Order updates, payment confirmations and account alerts will appear here once those features are live. Security emails already go to your inbox.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'No notifications yet','description' => 'Order updates, payment confirmations and account alerts will appear here once those features are live. Security emails already go to your inbox.']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\DELL\growza\growza\resources\views/dashboard/notifications.blade.php ENDPATH**/ ?>