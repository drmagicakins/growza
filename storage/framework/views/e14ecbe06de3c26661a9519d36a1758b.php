...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Transactions','heading' => 'Transactions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Transactions','heading' => 'Transactions']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['title' => 'No transactions yet','description' => 'Every wallet credit and debit will appear here with a reference you can reconcile, once payments are live.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'No transactions yet','description' => 'Every wallet credit and debit will appear here with a reference you can reconcile, once payments are live.']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\DELL\growza\growza\resources\views/dashboard/transactions.blade.php ENDPATH**/ ?>