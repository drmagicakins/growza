...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label' => null, 'name', 'error' => null, 'help' => null, 'options' => []]));
...
foreach (array_filter((['label' => null, 'name', 'error' => null, 'help' => null, 'options' => []]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH C:\Users\DELL\growza\growza\resources\views/components/select.blade.php ENDPATH**/ ?>