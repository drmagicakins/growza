...
<div <?php echo e($attributes->merge(['class' => 'text-center py-16 px-6'])); ?>>
    ...
    <h3 class="text-base font-semibold text-ink-900"><?php echo e($title); ?></h3>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($description): ?>
        <p class="mt-1.5 text-sm text-ink-500 max-w-sm mx-auto"><?php echo e($description); ?></p>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
