    ...
    <div class="max-w-content mx-auto px-6 py-16">
        <div class="grid gap-10 md:grid-cols-4">
            <div class="md:col-span-1">
                ...
                <p class="mt-2 text-sm text-ink-400 max-w-xs">{{ config('growza-marketing.company.tagline') }}</p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('why-growza') }}" class="hover:text-white">Why Growza</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('legal.refund-policy') }}" class="hover:text-white">Refund Policy</a></li>
                    <li><a href="{{ route('legal.acceptable-use') }}" class="hover:text-white">Acceptable Use</a></li>
                    <li><a href="{{ route('legal.cookie-policy') }}" class="hover:text-white">Cookie Policy</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="mt-12 pt-8 border-t border-ink-800 flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between text-sm text-ink-400">
            <p>&copy; {{ date('Y') }} {{ config('growza-marketing.company.name') }}. All rights reserved.</p>
