...
class DashboardController extends Controller
{
    ...
    /**
     * Services are browsable while logged in, reusing the same
     * config-driven content the marketing site uses (LEVEL 2) — but
     * placing an order is not possible until LEVEL 7, so every card says
     * so plainly instead of showing a button that does nothing.
     */
