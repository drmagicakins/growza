...
<header class="border-b border-ink-200 bg-white" x-data="{ mobileOpen: false }">
    <div class="max-w-content mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-3">
            <x-button as="a" href="{{ route('login') }}" variant="ghost" size="sm">Log in</x-button>
            <x-button as="a" href="{{ route('register') }}" variant="primary" size="sm">Get started</x-button>
        </div>
    ...
    <div x-show="mobileOpen" x-cloak class="md:hidden border-t border-ink-200 px-6 py-4 space-y-3">
        ...
        <div class="pt-3 flex gap-3">
            <x-button as="a" href="{{ route('login') }}" variant="secondary" size="sm" class="flex-1 justify-center">Log in</x-button>
            <x-button as="a" href="{{ route('register') }}" variant="primary" size="sm" class="flex-1 justify-center">Get started</x-button>
        </div>
    </div>
</header>
